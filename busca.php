...
<body>	
	...
	$consulta = $cn->query("select * from vw_produto where nm_produto like concat('%','$pesquisa','%')");
...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 150px;">
		...
		<div class="col-sm-1 col-sm-offset-1"><img src="imagens/<?php echo $exibe['ds_img']?>" class="img-responsive" style="width:100%;"></div>
		<div class="col-sm-5"><h4 style="padding-top:20px"><?php echo $exibe['nm_produto'];?></h4></div>
		<div class="col-sm-2"><h4 style="padding-top:20px"><b>Preço: </b> R$ <?php echo number_format ($exibe['vl_produto'],2,',','.');?></h4></div>
