...
<div class="container-fluid">
	...
	<div class="row" style="margin-top: 15px;">
		...
		<div class="col-sm-1 col-sm-offset-1"><img src="imagens/<?php echo $exibe['ds_img']; ?>" class="img-responsive"></div>
		<div class="col-sm-5"><h4 style="padding-top:20px"><?php echo $exibe['nm_produto']; ?></h4></div>
		<div class="col-sm-2" style="padding-top:20px">
		
			
		<a href="frmAlterar.php?id=<?php echo $exibe['cd_produto'];?>&id2=<?php echo $exibe['cd_categoria'];?>"> <!--&id3=<//?php echo $exibe['nm_produto'];?>">-->
